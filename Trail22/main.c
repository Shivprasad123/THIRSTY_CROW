...
void tree(){
	...
	glVertex2f(920.0,80.0);
	glVertex2f(830.0,80.0);
	glEnd();

	glBegin(GL_POLYGON);
	glVertex2f(920.0,80.0);
	glVertex2f(830.0,80.0);
	glVertex2f(810.0,750.0);
	glVertex2f(870.0,800.0);
	glEnd();

	glColor3f(0.3,0.6,0.0);
	glBegin(GL_POLYGON);
	glVertex2f(840.0,660.0);
	glVertex2f(800.0,590.0);
	glVertex2f(730.0,600.0);
	glVertex2f(710.0,660.0);
	glVertex2f(720.0,720.0);
	glVertex2f(665.0,740.0);
	glVertex2f(650.0,820.0);
	glVertex2f(680.0,890.0);
	glVertex2f(730.0,900.0);
	glVertex2f(740.0,970.0);
	glVertex2f(770.0,999.0);
	glVertex2f(880.0,999.0);
	glVertex2f(910.0,970.0);
	glVertex2f(920.0,900.0);
	glVertex2f(970.0,890.0);
	glVertex2f(999.0,840.0);
	glVertex2f(980.0,780.0);
	glVertex2f(960.0,750.0);
	glVertex2f(980.0,680.0);
	glVertex2f(970.0,620.0);
	glVertex2f(920.0,610.0);
	glVertex2f(880.0,630.0);
	glEnd();
}
